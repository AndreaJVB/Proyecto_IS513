...
class CircleAvatarCustomPlayer2 extends StatelessWidget {
  CircleAvatarCustomPlayer2({super.key});
  ...
  Widget build(BuildContext context) {
    PickAvatarPlayer2 pick = PickAvatarPlayer2(_avatars);

    return Obx(() {
      return CircleAvatar(
        backgroundImage: NetworkImage(avatar.avatarPlayer2.value),
        radius: 60,
...
///ESCOGER AVATAR
class PickAvatarPlayer2 {
  PickAvatarPlayer2(this.avatars);
                        ...
                        child: GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return GestureDetector(
                              onTap: () {
                                avatar.avatarPlayer2.value = avatars[index];
