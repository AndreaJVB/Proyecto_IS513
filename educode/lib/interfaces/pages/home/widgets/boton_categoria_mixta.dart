          ...
          if (seleccionadas != null && seleccionadas.length >= 2) {
            ...
            for ( final categoria in seleccionadas){
                if(categoria == 'Base de Datos'){
                  map [categoria] = ['https://raw.githubusercontent.com/Chrisherndz/educode_quizz/main/basedatos.json', 'BASE_DATOS'];
                }
                if(categoria == 'Algoritmos'){
                  map [categoria] = ['https://raw.githubusercontent.com/Chrisherndz/educode_quizz/main/algoritmo.json', 'algoritmo'];
                }
                if(categoria == 'Lenguaje de Programación'){
                  map [categoria] = ['https://raw.githubusercontent.com/Chrisherndz/educode_quizz/main/flutter.json', 'Flutter'];
                }
                if(categoria == 'Programación Orientada a Objetos'){
                  map [categoria] = ['https://raw.githubusercontent.com/Chrisherndz/educode_quizz/main/Programacion%20Orienta%20a%20Objeto.json', 'POO'];
                }
                if(categoria == 'Programación'){
                  map [categoria] = ['https://raw.githubusercontent.com/Chrisherndz/educode_quizz/main/programacion.json', 'programacion'];
                }
            }
