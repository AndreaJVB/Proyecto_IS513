...
class LenguajeProgramacionPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final QuizController controller =
        Get.put(QuizController(url: url, data1:'Flutter', topic: 'Lenguaje de Programación'));
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        return SingleChildScrollView( // Aquí se añade el SingleChildScrollView
          child: Padding(
                  ...
                  return Container(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                            fontSize: 20,
                            color: Colors.black), // Tamaño de la letra de las opciones
                        textAlign: TextAlign.center,
                      ),
                    ),
                  );
